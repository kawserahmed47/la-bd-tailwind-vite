                ...
                <div class="flex flex-wrap items-center">
                    <div class="hidden w-full xl:block xl:w-1/2">
                        <div class="py-17.5 px-26 text-center">
                            ...
                            <p class="font-medium 2xl:px-20">Welcome to Land Acquisition Management System</p>
                            ...
                            <span class="mt-15 inline-block">
                                <svg width="350" height="350" viewBox="0 0 350 350" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#FFB8B8" />
                                    <path d="M298.642 344.352H292.894L290.16 322.198L298.643 322.198L298.642 344.352Z"
                                        fill="#FFB8B8" />
                                    <path
                            ...
                            <div class="mt-6 text-center">
                                <p class="font-medium">
                                    Powered by
                                    <a href="#" class="text-primary">Adventure Soft Ltd.</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <div class="flex flex-wrap items-center mb-9">
                                <img src="{{ asset('images') }}/logo/logo-icon.png" height="30" width="30"
                                    alt="Logo" />
                                <h2 class="mx-4 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">Login to
                                    Land Aquisation</h2>
                            </div>
                            {{-- action="{{route('auth.loginCheck')}}" --}}
                            <form id="loginForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative" x-data="{ show: false }">
                                        <input x-bind:type="! show ? 'password' : 'text'" type="password" name="password" required placeholder="********"
                                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />

                                        <span  class="absolute right-4 top-4">
                                            <svg x-bind:class="! show ? '' : 'hidden'" x-on:click="show = ! show" class="fill-current lock " width="22" height="22" viewBox="0 0 22 22"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g opacity="0.5">
                                                    <path
                                            ...
                                            <svg x-bind:class="! show ? 'hidden' : ''" x-on:click="show = ! show" class="w-6 h-6 unlock " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.9" d="M18.5 8V4.5a3.5 3.5 0 1 0-7 0V8M8 12.167v3M2 8h12a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1Z"/>
                                            </svg>
                                        </span>
                                    </div>
                                </div>
