                                ...
                                <div class="relative">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative" x-data="{ show: false }">
                                            <input x-bind:type="!show ? 'password' : 'text'" type="password"
                                                name="password" required placeholder="********"
                                                class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />

                                            <span class="absolute right-4 top-4">
                                                <svg x-bind:class="!show ? '' : 'hidden'" x-on:click="show = ! show"
                                                    class="fill-current lock " width="22" height="22"
                                                    viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g opacity="0.5">
                                                        <path
                                                ...
                                                <svg x-bind:class="!show ? 'hidden' : ''" x-on:click="show = ! show"
                                                    class="w-6 h-6 unlock " aria-hidden="true"
        ...
        $(document).on('submit', "#loginForm", function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    thisForm.find('.form-loaded').removeClass('hidden flex').addClass('flex');
                ...
                error: function(xhr, status, error) {
                    thisForm.find('.form-loaded').removeClass('hidden flex').addClass('hidden');
