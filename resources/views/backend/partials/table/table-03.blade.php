<div
  ...
  <div class="flex flex-col border-b border-[#eee]  sm:flex-row sm:items-center sm:justify-between gap-3  py-4 px-4 md:px-6 xl:px-7.5">
      ...
      <a href="{{route('admin.organization.create')}}" class="inline-flex  items-center justify-center gap-2.5 rounded-full bg-primary py-2 px-5 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5">
        <span>
  ...
  <div class="max-w-full overflow-x-auto">
    <table class="w-full table-auto">
      ...
      <tbody>
        ...
        <tr>
          <td class=" py-3 px-4 pl-9 dark:border-strokedark xl:pl-11">
            <h5 class="font-medium text-black dark:text-white">
              Business Package
            </h5>
            <p class="text-sm">$99.00</p>
          </td>
          <td class=" py-3 px-4 dark:border-strokedark">
            <p class="text-black dark:text-white">Jan 13,2023</p>
          </td>
          <td class=" py-3 px-4 dark:border-strokedark">
