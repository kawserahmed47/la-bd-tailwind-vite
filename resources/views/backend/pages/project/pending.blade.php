@extends('backend.master', ['title' => 'Project List', 'page' => 'project-pending'])
...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            ...
            'breadcrumb_title_url' => route('admin.project.pending'),
        
            'breadcrumb_subtitle' => 'List',
            'breadcrumb_subtitle_url' => route('admin.project.pending'),
        ])
        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-bold text-lg font-weight-bolder">Pending project list</h2>
                ...
                <div class="relative max-w-full overflow-x-auto pb-5 project-pending-table-section">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            ...
                            @if (count($projects))
                                @foreach ($projects as $project)
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <p
                                                class="inline-flex rounded-full  {{ $project->status ? 'bg-success text-success' : 'bg-danger text-danger' }}  bg-opacity-10 py-1 px-3 text-sm font-medium">
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                ...
                                                <form class="project-pending-delete-form" method="POST"
                            ...
                            @else
                                <tr>
                                    <td colspan="4" class="text-danger text-center">No pending projects found!</td>
                                </tr>
                            @endif
...
@push('js')
    <script type="module">
    $(document).on('submit', '.project-pending-delete-form', function(e){
        e.preventDefault()
        let _this = $(this);
        let formLoaded = _this.closest('.project-pending-table-section').find('.form-loaded');
