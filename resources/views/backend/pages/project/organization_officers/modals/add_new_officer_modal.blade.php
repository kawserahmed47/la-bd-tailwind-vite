<div id="add-new-organization-officer-modal" tabindex="-1" aria-hidden="true"  class="modal fixed top-0 left-0 right-0 z-9999 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
<div class="relative max-w-md">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div id="manuLabelTabContent" class="p-5">
            <form id="project-organization-officer-store-form" method="POST"
                enctype="multipart/form-data"
                action="{{ route('admin.project-organization-officer.store') }}">
                @csrf
                ...
                <div class="relative">
                    <div class="p-3">
                        ...
                        <div class="mb-4.5">
                            ...
                            <select id="organization_designation_id"
                                name="organization_designation_id" required
                                class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                        ...
                        <div class="mb-4.5">
                            <label for="organization_officer_id"
                                class="mb-2.5 block text-black dark:text-white">
                                Organization Officer
                            </label>

                            <select id="organization_officer_id"
                                name="organization_officer_id" required
                                class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
