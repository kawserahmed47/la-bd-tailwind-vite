@extends('backend.master', ['title' => 'Project List', 'page' => 'project-finished'])
...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            ...
            'breadcrumb_title_url' => route('admin.project.finished'),
        
            'breadcrumb_subtitle' => 'List',
            'breadcrumb_subtitle_url' => route('admin.project.finished'),
        ])
                ...
                <div class="relative max-w-full overflow-x-auto pb-5 project-finished-table-section">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                ...
                                                <form class="project-finished-delete-form" method="POST"
                            ...
                            @else
                                <tr>
                                    <td colspan="4" class="text-danger text-center">No finished projects found!</td>
                                </tr>
                            @endif
...
@push('js')
    <script type="module">
    $(document).on('submit', '.project-finished-delete-form', function(e){
        e.preventDefault()
        let _this = $(this);
        let formLoaded = _this.closest('.project-finished-table-section').find('.form-loaded');
