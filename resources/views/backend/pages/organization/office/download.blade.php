...
<head>
    ...
    <title>{{$organization_office->name ?? 'Organization'}}</title>
</head>
<body>
    <table style="margin-left: auto; margin-right: auto;">
       ...
       <tbody>
        <tr>
            <td>Organization</td>
            <td>{{$organization_office->organization->name}}</td>
        </tr>
        <tr>
            <td>Name:</td>
            <td colspan="2">{{$organization_office->name}}</td>
        </tr>
        <tr>
            <td>Name in Bengali:</td>
            <td colspan="2">{{$organization_office->bn_name}}</td>
        </tr>
        <tr>
            <td>Address:</td>
            <td colspan="2">{{$organization_office->address}}</td>
        </tr>
        <tr>
            <td>Description:</td>
            <td colspan="2">{{$organization_office->description}}</td>
        </tr>
        <tr>
            <td>Status:</td>
            <td colspan="2">{{$organization_office->status ? 'Active' : 'Inactive'}}</td>
        </tr>
       </tbody>
    </table>
</body>
