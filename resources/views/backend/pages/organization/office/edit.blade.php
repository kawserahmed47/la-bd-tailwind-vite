...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            'breadcrumb_heading' => 'Organization Office Edit',
            'breadcrumb_title' => 'Organization Office',
            'breadcrumb_title_url' => route('admin.organization-office.index'),
            'breadcrumb_subtitle' => 'Edit',
            'breadcrumb_subtitle_url' => route('admin.organization-office.edit', $organization_office->id)
        ])
            ...
            <div class="flex flex-col gap-9">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-3 pb-2.5 sm:px-5.5 xl:pb-1">
                    <div class="flex flex-col border-b border-[#eee] sm:flex-row sm:items-center sm:justify-between gap-3  py-4 px-4 md:px-6 xl:px-7.5">
                        <h2 class="text-bold text-lg font-weight-bolder">Organization Office edit form</h2>
                        ...
                        <form id="organization-office-store-form" method="POST" enctype="multipart/form-data" action="{{route('admin.organization-office.update', $organization_office->id)}}">
                            @csrf
                            @method('put')
                            <div class="relative">
                                <div class="p-6.5">
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="name" name="name" value="{{$organization_office->name}}" placeholder="Name in English"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="bn_name" name="bn_name" value="{{$organization_office->bn_name}}" placeholder="Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            <div class="mb-6">
                                                ...
                                                <textarea rows="3" id="address" name="address" placeholder="Type organization office address"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            <div class="mb-6">
                                                ...
                                                <textarea rows="3" id="description" name="description" placeholder="Type organization office description"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input class="mr-2 leading-tight" value="1" id="status" name="status" type="checkbox" {{$organization_office->status ? 'checked' : ''}}>
                                        <span class="text-sm">
...
@push('js')
<script type="module">
    $(document).on('submit', '#organization-office-store-form', function(e){
        e.preventDefault();
        let _this = $(this);
        $.ajax({
            type: "put",
            url: "{{route('admin.organization-office.update', $organization_office->id)}}",
            ...
            success: function (response) {
                ...
                location.href = "{{route('admin.organization-office.index')}}";
            },
            error: function (xhr) {
                _this.find('.form-loaded').removeClass('hidden flex').addClass('hidden');
