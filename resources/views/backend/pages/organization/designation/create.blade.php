...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            'breadcrumb_heading' => 'Organization Designation Create',
            ...
            'breadcrumb_subtitle_url' => route('admin.organization-designation.create')
        ])
            ...
            <div class="flex flex-col gap-9">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-3 pb-2.5 sm:px-5.5 xl:pb-1">
                    <div class="flex flex-col border-b border-[#eee] sm:flex-row sm:items-center sm:justify-between gap-3  py-4 px-4 md:px-6 xl:px-7.5">
                        <h2 class="text-bold text-lg font-weight-bolder">New organization designation form</h2>
                        ...
                        <form id="organization-designation-store-form" method="POST" enctype="multipart/form-data" action="{{route('admin.organization-designation.store')}}">
                            @csrf
                            <div class="relative">
                                <div class="p-6.5">
                                    <div class="mb-6">
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="name" name="name" placeholder="Designation Name in English"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            <label for="bn_name" class="mb-2.5 block text-black dark:text-white">
                                               Designation Name in Bengali
                                            </label>
                                            <input type="text" id="bn_name" name="bn_name" placeholder="Designation Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
...
<script type="module">
    $(document).on('submit', '#organization-designation-store-form', function(e){
        ...
        $.ajax({
            type: "post",
            url: "{{route('admin.organization-designation.store')}}",
