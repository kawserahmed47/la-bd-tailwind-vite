...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            'breadcrumb_heading' => 'Organization Officer Edit',
            'breadcrumb_title' => 'Organization Officer',
            'breadcrumb_title_url' => route('admin.organization-officer.index'),
            'breadcrumb_subtitle' => 'Edit',
            'breadcrumb_subtitle_url' => route('admin.organization-officer.edit', $organization_officer->id)
        ])
            ...
            <div class="flex flex-col gap-9">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-3 pb-2.5 sm:px-5.5 xl:pb-1">
                    <div class="flex flex-col border-b border-[#eee] sm:flex-row sm:items-center sm:justify-between gap-3  py-4 px-4 md:px-6 xl:px-7.5">
                        <h2 class="text-bold text-lg font-weight-bolder">Organization Officer edit form</h2>
                        ...
                        <form id="organization-officer-store-form" method="POST" enctype="multipart/form-data" action="{{route('admin.organization-officer.update', $organization_officer->id)}}">
                            @csrf
                            @method('put')
                                ...
                                <div class="p-6.5">
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="name" required name="name" value="{{$organization_officer->user->name ?? ''}}" placeholder="Officer Name in English"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="bn_name" required name="bn_name" value="{{$organization_officer->user->bn_name ?? ''}}" placeholder="Officer Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="mobile" required name="mobile" value="{{$organization_officer->user->mobile}}" placeholder="Officer Name in English"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="email" id="email" required name="email" value="{{$organization_officer->user->email}}" placeholder="Officer Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input class="mr-2 leading-tight" id="status" value="1" name="status" type="checkbox" {{$organization_officer->status ? 'checked' : ''}}>
                                        <span class="text-sm">
