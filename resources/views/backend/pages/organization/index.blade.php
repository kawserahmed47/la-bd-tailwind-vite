        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-bold text-lg font-weight-bolder">Latest organization list</h2>
                ...
                <div class="relative max-w-full overflow-x-auto pb-5 organization-table-section">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                                ...
                                @foreach ($organizations as $organization)
                                    <tr>
                                        <td class="border-b border-[#eee] py-3 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white">{{ $organization->name }}
                                            </h5>
                                            <p class="text-sm">{{ $organization->bn_name }}</p>
                                        </td>
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <p
                                                class="inline-flex rounded-full  {{ $organization->status ? 'bg-success text-success' : 'bg-danger text-danger' }}  bg-opacity-10 py-1 px-3 text-sm font-medium">
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                ...
                                                <a data-tooltip-target="tooltip-download" data-tooltip-placement="top"
                                                    href="{{ route('admin.organization.download', $organization->slug) }}"
                                                    target="_blank"
                                                    class="hover:text-primary">
                                                    <svg class="fill-current text-gray-500 dark:text-white" width="18"
                                                        height="18" viewBox="0 0 18 18" fill="none"
                                                ...
                                                <form class="organization-delete-form" method="POST"
                            ...
                            @else
                                <tr>
                                    <td colspan="4" class="text-danger text-center">No organizations found!</td>
                                </tr>
                            @endif
...
@push('js')
    <script type="module">
    $(document).on('submit', '.organization-delete-form', function(e){
        e.preventDefault()
        let _this = $(this);
        let formLoaded = _this.closest('.organization-table-section').find('.form-loaded');
