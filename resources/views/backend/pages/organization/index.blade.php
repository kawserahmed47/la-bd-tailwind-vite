        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="font-semibold text-title-md2 text-black dark:text-white">Latest organization list</h2>
                ...
                <div class="max-w-full overflow-x-auto">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                                ...
                                @foreach ($organizations as $organization)
                                    <tr>
                                        <td class="border-b border-[#eee] py-3 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white">{{$organization->name}}</h5>
                            ...
                            @else
                                <tr>
                                    <th class="text-danger text-center">No organizations found!</th>
                                </tr>
                            @endif
