...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
        @include('backend.partials.breadcrumb', [
            'breadcrumb_heading' => 'Organization Show',
            'breadcrumb_title' => 'Organization',
            'breadcrumb_title_url' => route('admin.organization.index'),
            'breadcrumb_subtitle' => 'Show',
            'breadcrumb_subtitle_url' => route('admin.organization.show', $organization->id)
        ])
            ...
            <div class="flex flex-col gap-9">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-3 pb-2.5 sm:px-5.5 xl:pb-1">
                    <div class="flex flex-col border-b border-[#eee] sm:flex-row sm:items-center sm:justify-between gap-3  py-4 px-4 md:px-6 xl:px-7.5">
                        <h2 class="text-bold text-lg font-weight-bolder">Organization informaton</h2>
                        ...
                        <form id="organization-store-form" method="POST" enctype="multipart/form-data" action="{{route('admin.organization.update', $organization->id)}}">
                            @csrf
                            @method('put')
                            <div class="relative">
                                <div class="p-6.5">
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="name" name="name" disabled value="{{$organization->name}}" placeholder="Name in English"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="bn_name" name="bn_name" disabled value="{{$organization->bn_name}}" placeholder="Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea rows="6" id="description" name="description" disabled placeholder="Type organization description"
                                            class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">{{$organization->description}}</textarea>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input class="mr-2 leading-tight" value="1" id="status" name="status" disabled type="checkbox" {{$organization->status ? 'checked' : ''}}>
                                        <span class="text-sm">
                                            Active Organization
                                        </span>
                                        </label>
