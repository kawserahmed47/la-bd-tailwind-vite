                                ...
                                <div class="p-6.5">
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <div class="relative z-20 bg-transparent dark:bg-form-input">
                                                <select id="section_id" disabled required name="section_id" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <select id="role_id" name="role_id" disabled required class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="name" disabled required name="name" value="{{$section_officer->user->name ?? ''}}" placeholder="Officer Name in English"
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" disabled id="bn_name" required name="bn_name" value="{{$section_officer->user->bn_name ?? ''}}" placeholder="Officer Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="text" id="mobile" disabled required name="mobile" value="{{$section_officer->user->mobile}}" placeholder="Officer Name in English"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                        ...
                                        <div class="w-full xl:w-1/2">
                                            ...
                                            <input type="email" disabled id="email" required name="email" value="{{$section_officer->user->email}}" placeholder="Officer Name in Bengali"
                                                class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input class="mr-2 leading-tight" id="status" disabled value="1" name="status" type="checkbox" {{$section_officer->status ? 'checked' : ''}}>
                                        <span class="text-sm">
