@extends('backend.master', ['title' => 'Ministry List', 'page' => 'ministry'])
        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-bold text-lg font-weight-bolder">Latest ministry list</h2>
                    <a href="{{ route('admin.ministry.create') }}"
                ...
                <div class="relative max-w-full overflow-x-auto pb-5 ministry-table-section">
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                                ...
                                @foreach ($ministries as $ministry)
                                    <tr>
                                        <td class="border-b border-[#eee] py-3 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                            <h5 class="font-medium text-black dark:text-white">{{ $ministry->name }}
                                            </h5>
                                            <p class="text-sm">{{ $ministry->bn_name }}</p>
                                        </td>
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <p
                                                class="inline-flex rounded-full  {{ $ministry->status ? 'bg-success text-success' : 'bg-danger text-danger' }}  bg-opacity-10 py-1 px-3 text-sm font-medium">
                                        ...
                                        <td class="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                <a data-tooltip-target="tooltip-edit" data-tooltip-placement="top"
                                                    href="{{ route('admin.ministry.edit', $ministry->id) }}"
                                                ...
                                                <a data-tooltip-target="tooltip-show" data-tooltip-placement="top"
                                                    href="{{ route('admin.ministry.show', $ministry->id) }}"
                                                    class="hover:text-primary">
                                                ...
                                                <a data-tooltip-target="tooltip-download" data-tooltip-placement="top"
                                                    href="{{ route('admin.ministry.download', $ministry->slug) }}"
                                                ...
                                                <form class="ministry-delete-form" method="POST"
                                                    action="{{ route('admin.ministry.destroy', $ministry->id) }}">
                                                    @csrf
                                                    @method('delete')
                            ...
                            @else
                                <tr>
                                    <td colspan="4" class="text-danger text-center">No ministries found!</td>
                                </tr>
                            @endif
...
@push('js')
    <script type="module">
        $(document).on('submit', '.ministry-delete-form', function(e) {
            e.preventDefault()
            let _this = $(this);
            let formLoaded = _this.closest('.ministry-table-section').find('.form-loaded');
