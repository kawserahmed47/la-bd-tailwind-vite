...
<div class="mx-auto max-w-screen-2xl p-4 md:p-3 2xl:p-5">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      ...
      <div
        ...
        <div class="mt-4 flex items-end justify-between">
          <div class="flex items-center gap-1 text-sm font-medium text-meta-3">
            <svg class="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
      ...
      <!-- Card Item End -->
       ...
       <div class="mt-4 flex items-end justify-between">
         <div class="flex items-center gap-1 text-sm font-medium text-meta-3">
          <svg class="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 21">
     ...
     <!-- Card Item End -->
      ...
      <!-- Card Item End -->
       ...
       <div class="mt-4 flex items-end justify-between">
         <div class="flex items-center gap-1 text-sm font-medium text-meta-3">
          <svg class="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
